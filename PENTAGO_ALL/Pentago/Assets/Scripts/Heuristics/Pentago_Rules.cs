...
public partial class Pentago_Rules : IGameRules<Pentago_GameBoard, Pentago_Move>
{
    ...
    public const float MAX_HEURISTIC_VALUE = 1000000;
    public const float MIN_HEURISTIC_VALUE = -1000000;
    ...
    public Pentago_GameBoard[] next_states(Pentago_GameBoard gb, int depth=0)
    {
        ...
        if (remove_repeated_states_on_nextStates && gb.get_turn_state() == Pentago_GameBoard.turn_state_rotate && emptyholes>29)
    ...
    public Pentago_Move[] sucessor(Pentago_GameBoard gb, int depth=0)
    {
        switch (nsf)
        {
            ...
            case NextStatesFunction.check_symmetries:
                ...
                if(!emptyholes.HasValue) emptyholes = gb.emptyholes;//gb.board.Count(o => o == Pentago_GameBoard.hole_state.is_empty);
                ...
                if (emptyholes > number_of_empty_holes_symmetries_soft_spot 
                  ...
                  emptyholes % 2==0//emptyholes%2==0//same as above but faster
    ...
    {
        emptyholes = gb.emptyholes;//gb.board.Count(o => o == Pentago_GameBoard.hole_state.is_empty);
